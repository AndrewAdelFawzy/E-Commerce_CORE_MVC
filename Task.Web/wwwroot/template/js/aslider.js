var aslider = {
    ...
    /* Configuration */
    slideFade: "display: block; opacity: 1; top: 0; position: absolute; right: 0; overflow: hidden; transition: opacity 1s ease-in-out; -moz-transition: opacity 1s ease-in-out; -webkit-transition: opacity 1s ease-in-out;",
    ...
    muteIconStyle: "display: block; height: 25px; width: 25px; position: absolute; right: 30px; top: 0px;",
    playPauseIconStyle: "display: block; height: 25px; width: 25px; position: absolute; right: 75px; top: 0px;",
